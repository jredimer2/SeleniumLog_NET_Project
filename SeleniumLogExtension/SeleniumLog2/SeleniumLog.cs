...
namespace SeleniumLogger
{
    ...
    {
        private static _MessageSettings MessageSettings;
        ...
        private Hashtable _SavedIndents = new Hashtable();
        ...
        public int IndentLevel { get { return MessageSettings.GetPendingLevel(); } }
        ...
        {
            _SavedIndents.Add(Name, IndentLevel);
        }

        public void RestoreIndent(string Name)
        {
            int irestore = Convert.ToInt16(_SavedIndents[Name]);
            IndentTo(irestore);
        }
        ...
        {
            if (Config.ScreenshotOnEveryPass)
                Screenshot();
            Green();
        ...
        {
            if (Config.ScreenshotOnEveryFail)
                Screenshot();
            Red();
        ...
        {
            if (Config.ScreenshotOnEveryWarning)
                Screenshot();
        ...
        {
            if (Config.ScreenshotOnEveryError)
                Screenshot();
